...
import id.langgan.android.databinding.FragmentSubscriberBinding
...
class SubscriberFragment : Fragment(), Injectable {
    ...
    var binding by autoCleared<FragmentSubscriberBinding>()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_subscriber, container, false, dataBindingComponent)
...
//            shimmer.stopShimmer()
    ...
    private fun details(data: Subs) {
        Timber.d("subs ${data.address}")
    }
